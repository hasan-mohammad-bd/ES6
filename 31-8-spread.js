...
console.log(maxInArray); //mac can't get the max number out of an array. in this case ... can be used to get the number first than find max value.


//adding a new value the a new array will
//==========================================================
// numbers.push(55);
...
numbers.push(55); //55 is not adding with the new array 
console.log(numbers);
